WOrdS = [
    "apple", "banana", "orange", "grapes", "mango", "peach", "cherry", "melon",
    "papaya", "guava", "lemon", "lime", "coconut", "avocado", "carrot", "potato",
    "tomato", "onion", "garlic", "pepper", "broccoli", "spinach", "cabbage",
    "pumpkin", "radish", "school", "college", "teacher", "student", "library",
    "notebook", "pencil", "eraser", "science", "history", "physics", "biology",
    "chemistry", "algebra", "python", "javascript", "compiler", "keyboard",
    "monitor", "internet", "website", "browser", "database", "network", "server",
    "gaming", "console", "controller", "adventure", "puzzle", "strategy",
    "football", "cricket", "tennis", "badminton", "hockey", "volleyball",
    "basketball", "captain", "stadium", "journey", "holiday", "airport",
    "station", "highway", "village", "country", "mountain", "desert", "forest",
    "ocean", "island", "planet", "galaxy", "comet", "rocket", "astronaut",
    "sunrise", "sunset", "thunder", "rainfall", "weather", "winter", "summer",
    "autumn", "spring", "friend", "family", "brother", "sister", "father",
    "mother", "uncle", "aunt", "cousin", "garden", "flower", "butterfly",
    "diamond", "crystal", "treasure", "shadow", "mirror", "blanket", "window",
    "curtain", "pillow", "kitchen", "bedroom", "balcony", "freedom", "justice",
    "wisdom", "honesty", "courage", "respect", "silence", "passion", "dream",
    "future", "success", "failure", "victory", "mystery", "monster", "dragon",
    "wizard", "knight", "castle", "kingdom", "legend", "ancient", "pirate",
    "ninja", "samurai", "hunter", "warrior", "machine", "factory", "battery",
    "engine", "vehicle", "bicycle", "airplane", "submarine", "camera", "speaker",
    "headphone", "backpack", "wallet", "ticket", "festival", "concert"
]
...
words_hints = {
    ...
    "mango": "A tropical sweet fruit",
    "peach": "A soft fruit with fuzzy skin",
    "cherry": "A small red fruit with a seed",
    "melon": "A large juicy fruit",
    "papaya": "A tropical fruit with orange flesh",
    "guava": "A tropical fruit rich in vitamin C",
    "lemon": "A sour yellow citrus fruit",
    "lime": "A small green citrus fruit",
    "coconut": "A hard tropical fruit with water inside",
    ...
    "garlic": "A strong-smelling cooking ingredient",
    "pepper": "A spicy vegetable or seasoning",
    "broccoli": "A green vegetable shaped like a tree",
    "spinach": "A leafy green vegetable",
    "cabbage": "A round leafy vegetable",
    "pumpkin": "A large orange vegetable used on Halloween",
    "radish": "A small spicy root vegetable",
    ...
    "compiler": "Turns code into executable programs",
    "keyboard": "Used to type on a computer",
    "monitor": "Displays images from a computer",
    "internet": "A worldwide network connection",
    "website": "A collection of web pages",
    "browser": "Used to access websites",
    "database": "Stores organized information",
    "network": "Connected systems or computers",
    "server": "Provides data to other computers",
    "gaming": "Playing video games",
    "console": "A device used for gaming",
    "controller": "Used to control games",
    "adventure": "An exciting experience or journey",
    "puzzle": "A game that tests thinking",
    "strategy": "A plan to achieve success",
    "football": "A popular team sport",
    "cricket": "A bat-and-ball sport",
    "tennis": "A racket sport",
    "badminton": "A sport played with a shuttlecock",
    "hockey": "A sport played with sticks",
    "volleyball": "A sport played over a net",
    "basketball": "A sport involving hoops",
    "captain": "The leader of a team",
    "stadium": "A large sports venue",
    "journey": "Travel from one place to another",
    "holiday": "A period of vacation",
    ...
    "cousin": "A relative of similar age",
    ...
    "crystal": "A clear mineral structure",
    "treasure": "Something valuable and hidden",
    ...
    "respect": "Showing admiration for others",
    "silence": "Complete absence of sound",
    "passion": "Strong enthusiasm or love",
    "dream": "Thoughts seen during sleep or goals",
    "future": "The time yet to come",
    "success": "Achieving goals",
    "failure": "Not succeeding",
    "victory": "Winning something",
    ...
    "knight": "An armored warrior",
    "castle": "A large fortified building",
    "kingdom": "Land ruled by a king or queen",
    "legend": "A famous old story",
    "ancient": "Very old",
    "pirate": "A thief who attacks ships",
    "ninja": "A stealthy Japanese warrior",
    "samurai": "A Japanese warrior class",
    ...
    "headphone": "Worn to listen to audio",
    "backpack": "A bag carried on the back",
    "wallet": "Used to hold money and cards",
    "ticket": "Allows entry or travel",
    "festival": "A public celebration",
